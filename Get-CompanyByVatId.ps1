...
function Get-CompanyByVatId {
    ...
    $CompanyObject | Add-Member -MemberType NoteProperty -Name 'Visiting Street' -Value $CompanyVisitingAddress.street
    ...
    $CompanyObject | Add-Member -MemberType NoteProperty -Name 'Postal Street' -Value $CompanyPostalAddress.street
